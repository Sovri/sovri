...
- `bot`: a `.sovri.yml` YAML syntax failure now posts a PR comment naming the
  file instead of the bare `review failed`, without echoing the raw parser
  cause (which may quote untrusted file bytes) (#2644, R-02).
