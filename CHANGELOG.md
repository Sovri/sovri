...
- `feat(compliance)`: add the compliance mapping entry schema, static CWE map
  loader API implementation, initial `CWE-798` static mapping data, and
  acceptance coverage for applicability, conditional references, missing CWE
  lookups, and public type exports.
