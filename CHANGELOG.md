...
- `fix(llm-providers)`: handle OpenAI optional null sentinels inside union schema branches, preserve
  caller-allowed null values, and document the typed OpenAI provider error hierarchy.
